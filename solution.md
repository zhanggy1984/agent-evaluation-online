...
auto-fixed 判据 = **claim 固化 K（claim_k）+ claimed-case 级纯净判据**（v3.5.5 = Task #4-③ R-1/R-2，同步 solution_detail §7.6 v1.5 / offline error-backflow-phase2.md v0.6.2 注记）：

...
> | 类 | 含义 | 条目 | 数 |
> |---|---|---|---|
> | **甲 真待处置** | 有对象要动（数据/schema/代码/文档/判据） | **F-1、F-2、F-5、F-12、F-17** | 5 |
> | **乙 已闭合** | 记录验证结论或已订正事实，动作已完成，**无需再动** | F-3、F-4、F-6、F-7、F-8、F-9、F-10、F-11、**F-13、F-14、F-15、F-16、F-18、F-19、F-20、F-22、F-23** | 17 |
> **⑪ 甲→乙 迁移（2026-09-14，T-3.12 批 2d）**：**F-19 由甲移乙**。它入甲的理由是「有对象要动」——该对象**已由 T-3.12 四个批逐段处置完毕**（批 1/2a-1/2a-2/2b 落地六端点，rotate 下移 T-5.3，§8.5.1 **显式裁定不做**）⇒ **已无未处置对象**，甲类依据消失。这条迁移不是「把没做完的划掉」：不做的那部分有**逐条依据与留档**（§8.5.1 三条理由见 F-19 小节），与「未完成」是两回事。

...
> 按此口径，本区在此条订立（2026-09-15）之前落地的旧行，其「未 push / 未 commit」即为时效残留，
> **经 2026-09-15 实测确认已为假，有意不回填**——逐行回填证不出各批真实推送时点，反而将其伪造成回填当刻。
